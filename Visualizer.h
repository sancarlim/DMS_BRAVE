...
namespace Utilities
{
	...
	*/
	...
	public:
		...
		void SetDIP(double DIP, double DLI);
		void SetIL(double IL);
		
		
		void SetParameters(double Aperture, int n_yawn, double yawning, double blink, double PERCLOS, int nblinks);

		void SetGaze(cv::Vec2d gaze, int count, int state);
